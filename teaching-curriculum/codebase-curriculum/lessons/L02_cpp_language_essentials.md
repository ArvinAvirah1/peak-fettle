# L02: C++ Language Essentials in Peak Fettle

**Domain:** Desktop/mobile Qt C++ framework, type-safe fitness tracking  
**Level:** Introductory → intermediate (Bloom L1–L5)  
**Estimate:** 2–3 hours to complete all sections  
**Prerequisites:** L01 (Peak Fettle domain model); basic C++ syntax (variables, functions, classes)  
...
Answer the following three questions *before* reading Section 3. Record your confidence (1–5) on each.
...
- (A) Compile error
- (B) Runtime error
- (C) Silent wrap-around (200 % 256 = -56 in quint8)
...
4. **Estimate time for L03:**
   - Based on L02 completion time and score, estimate L03 will take 2.5–3.5 hours
   - Recommend scheduling L03 within 1 week (while L01 and L02 are fresh)
