/**
 * Product identity constants — Life OS companion app.
 *
 * Q7 (app name) is still OPEN. Everything user-facing reads PRODUCT_NAME from
 * here so the final name is a one-line swap. Do NOT hardcode the name in
 * screens, copy, or notification templates.
 *
...
export const PRODUCT_NAME = 'Peak Fettle Life OS'; // WORKING TITLE — Q7 pending
export const PRODUCT_SHORT = 'Life OS';
export const COMPANION_FITNESS_NAME = 'Peak Fettle';

/** Deep-link scheme (matches app.json `scheme`). */
export const URL_SCHEME = 'lifeos';

/** App Group shared with the FamilyControls extensions (matches app.json). */
