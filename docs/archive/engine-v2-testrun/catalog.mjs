// catalog.mjs — Engine v2 prototype exercise catalogue (dependency-free ESM)
// -----------------------------------------------------------------------------
...
// muscles[] uses canonical labels: chest, back, upper_back, shoulders, front_delts,
// side_delts, rear_delts, biceps, triceps, quads, hamstrings, glutes, calves, abs,
// traps, forearms, full_body. primaryMuscle drives the volume tally (1.0);
// synergists count 0.5 (RESEARCH.md §1.1 counting convention).
const RAW = [
  // ── squat pattern ──
  ...
  { name: 'Front Squat', pattern: 'squat', is_compound: true, equipment: ['barbell','rack'], primary: 'quads', muscles: ['quads','glutes'], contra: ['knees','wrists'], safeFor: ['lower_back'] }, // upright torso
  { name: 'Box Squat', pattern: 'squat', is_compound: true, equipment: ['barbell','rack','bench'], primary: 'quads', muscles: ['quads','glutes','hamstrings'], contra: [], safeFor: ['knees','hip'] }, // controlled depth
  { name: 'Leg Press', pattern: 'squat', is_compound: true, equipment: ['machine'], primary: 'quads', muscles: ['quads','glutes'], contra: [], safeFor: ['lower_back','knees'] }, // supported, ROM-limitable
  ...
  { name: 'Trap-Bar Deadlift', pattern: 'hinge', is_compound: true, equipment: ['barbell'], primary: 'hamstrings', muscles: ['hamstrings','glutes','quads','back'], contra: [], safeFor: ['lower_back'] }, // upright torso, less shear
  ...
  { name: 'Hip Thrust', pattern: 'hinge', is_compound: true, equipment: ['barbell','bench'], primary: 'glutes', muscles: ['glutes','hamstrings'], contra: [], safeFor: ['lower_back','knees'] }, // neutral spine
  ...
  { name: 'Close-Grip Bench Press', pattern: 'horizontal_push', is_compound: true, equipment: ['barbell','bench'], primary: 'chest', muscles: ['chest','triceps'], contra: ['wrists'], safeFor: ['shoulders'] }, // less AC/impingement
  { name: 'Floor Press', pattern: 'horizontal_push', is_compound: true, equipment: ['barbell','dumbbell'], primary: 'chest', muscles: ['chest','triceps'], contra: [], safeFor: ['shoulders'] }, // partial ROM, no bottom distraction
  ...
  { name: 'Landmine Press', pattern: 'vertical_push', is_compound: true, equipment: ['barbell'], primary: 'shoulders', muscles: ['shoulders','front_delts','triceps'], contra: [], safeFor: ['shoulders'] }, // shoulder-friendly arc
  ...
  { name: 'Pogo Hops', pattern: 'plyometric', is_compound: true, plyo: true, equipment: ['bodyweight'], primary: 'calves', muscles: ['calves','quads'], contra: ['ankles'], safeFor: ['knees'] }, // low-intensity, knee-friendly
  ...
  { name: 'Seated Box Jump', pattern: 'plyometric', is_compound: true, plyo: true, equipment: ['bodyweight','bench'], primary: 'quads', muscles: ['quads','glutes'], contra: [], safeFor: ['knees','ankles'] }, // concentric-only, low landing stress
  ...
  { name: 'Hammer Curl', pattern: 'isolation_arms', is_compound: false, equipment: ['dumbbell'], primary: 'biceps', muscles: ['biceps','forearms'], contra: [], safeFor: ['elbows','wrists'] }, // neutral grip
  ...
  { name: 'Rope Tricep Pushdown', pattern: 'isolation_arms', is_compound: false, equipment: ['cable','machine'], primary: 'triceps', muscles: ['triceps'], contra: [], safeFor: ['elbows'] }, // neutral rope
  ...
  { name: 'Face Pull', pattern: 'isolation_shoulders', is_compound: false, equipment: ['cable','bands'], primary: 'rear_delts', muscles: ['rear_delts','upper_back'], contra: [], safeFor: ['shoulders'] }, // cuff/scap health
...
export const CATALOG = RAW.map((e) => ({
  id: localId(e.name),
  name: e.name,
